...
public partial class AdventureWorksLt2019Context : DbContext
{
    ...
    public virtual DbSet<ProductModel1> ProductModels1 { get; set; }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseSqlServer("Server=CENGIZHNX\\SQLEXPRESS;Database=AdventureWorksLT2019;Trusted_Connection=True;TrustServerCertificate=True");
